/**
 * @file Icon - SVG 图标组件集合
 * @description 使用内联 SVG，避免额外依赖。所有图标继承 currentColor。
 */
...
export const SearchIcon = memo((props: IconProps) => (
  <BaseIcon {...props}>
...
export const MoonIcon = memo((props: IconProps) => (
  <BaseIcon {...props}>
    <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />
  </BaseIcon>
));

export const MonitorIcon = memo((props: IconProps) => (
  <BaseIcon {...props}>
...
export const PaperIcon = memo((props: IconProps) => (
  <BaseIcon {...props}>
...
export const FolderPlusIcon = memo((props: IconProps) => (
  <BaseIcon {...props}>
    <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" />
...
export const BellIcon = memo((props: IconProps) => (
  <BaseIcon {...props}>
...
export const UploadIcon = memo((props: IconProps) => (
  <BaseIcon {...props}>
    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
...
export const RestoreIcon = memo((props: IconProps) => (
  <BaseIcon {...props}>
...
export const KeyboardIcon = memo((props: IconProps) => (
  <BaseIcon {...props}>
