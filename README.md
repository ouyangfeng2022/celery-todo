...
在 [v3.7.0 正式版](https://github.com/ouyangfeng2022/celery-todo/releases/tag/v3.7.0) 或 [最新 Release](https://github.com/ouyangfeng2022/celery-todo/releases/latest) 下载对应平台的安装包。

| 平台                | 文件                                                                 |
| ------------------- | -------------------------------------------------------------------- |
| Windows x64         | `Celery.Todo_3.7.0_x64-setup.exe`                                    |
| macOS Apple Silicon | `Celery.Todo_3.7.0_aarch64.dmg`                                      |
| macOS Intel         | `Celery.Todo_3.7.0_x64.dmg`                                          |
| Linux               | `Celery.Todo_3.7.0_amd64.AppImage` 或 `Celery.Todo_3.7.0_amd64.deb` |
| Android             | `Celery.Todo_3.7.0_android.apk`                                      |
