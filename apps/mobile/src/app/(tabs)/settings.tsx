/**
 * @file 设置页：主题（纸白/暗色/芹绿，@celery/ui-tokens 三色板）+ 关于。
 */
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 32 }}>
        ...
        {THEME_KEYS.map((key) => {
          ...
          return (
            ...
            >
              <View
                style={[styles.swatch, { backgroundColor: palette(key).accent }]}
              />
        ...
        <View style={[styles.card, { backgroundColor: colors.bgTertiary, borderColor: colors.border }]}>
